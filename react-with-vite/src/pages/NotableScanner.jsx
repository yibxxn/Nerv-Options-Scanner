...
export default function NotableScanner() {
    ...
    return (
      <>
          <h1 className="text-3xl font-bold">Unusual Options activity</h1>
          <br></br>
              ...
              <tbody>
                {sortedData.map((opt, index) => (
                  <tr key={index} className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td className="px-6 py-4"><img width="20" height="20" src="https://img.icons8.com/ios/50/FFFFFF/visible--v1.png" alt="visible--v1"/></td>
                  </tr>
                ))}
              </tbody>
            </table>
